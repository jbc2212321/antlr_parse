...
selectStmt:
    withClause?
    SELECT DISTINCT? topClause? columnExprList(COMMA)?
    fromClause?
    arrayJoinClause?
    windowClause?
    prewhereClause?
...
tealimitClause: TEALIMIT tealimitExpr;
...
tealimitExpr: numberLiteral GROUP;
...
columnExpr
    ...
    | IDENTIFIER LBRACE literal RBRACE                                                    # ColumnExprBraceParam
